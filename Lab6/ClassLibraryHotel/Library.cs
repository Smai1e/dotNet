...
namespace ClassLibrary
{
    public class Library
    {
        ...
        /// Словарь читателей
        /// </summary>
        public Dictionary<int, Reader> _readers = new Dictionary<int, Reader>();
        /// <summary>
        /// Словарь книг
        /// </summary>
        public Dictionary<int, Book> _books = new Dictionary<int, Book>();
        /// <summary>
        /// Спосок выданных книг
        /// </summary>
        public List<IssuedBook> _issuedBooks = new List<IssuedBook>();
